...
def saveDataToFiles():
    now = datetime.now()
    path = "/home/tgknyhn/Desktop/testFiles/test_" + str(now)
    index1 = 100
    index2 = 200
    index3 = 300
    index4 = 400
    ...
    while True:
        ...
        if var_data:
            ...
            if(recordFlag[0] == True):
                ...
                l.config(text = getElapsedTimeText(length / 50.0))
...
ani = animation.FuncAnimation(fig, animate, fargs=(xs,ys, data), interval=20, blit=False)
